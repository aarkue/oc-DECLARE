/* tslint:disable */
/* eslint-disable */
export const load_ocel_json: (a: number, b: number) => void;
...
export const discover_oc_declare_constraints: (a: number) => [number, number, number, number];
export const greet: () => void;
export const unload_ocel: () => void;
